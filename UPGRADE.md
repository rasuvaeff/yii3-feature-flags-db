...
```
M260605000000CreateFeatureFlagsTable
...
```sql
UPDATE migration
SET name = 'Rasuvaeff\\Yii3FeatureFlagsDb\\Migration\\M260605000000CreateFeatureFlagsTable'
WHERE name = 'M260605000000CreateFeatureFlagsTable';
```
...
-    'setSourcePaths()' => [[__DIR__ . '/../vendor/rasuvaeff/yii3-feature-flags-db/migrations']],
